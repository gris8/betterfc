...
|===
|               [big]#Linux Netlink as an IP Services Protocol#
|===
...
diversity ranging from dynamic routing protocols, such as OSPF [<<ref_5>>],
to tag distribution protocols, such as CR-LDP [<<ref_7>>]. Classical
management protocols and activities also fall under this category.
These include SNMP [<<ref_6>>], COPS [<<ref_4>>], and proprietary CLI/GUI
...
indicated blocks.  More information can be found at [<<ref_10>>] and [<<ref_11>>].
...
// XXX(andy): asciidoctor renders the '-' as circle
...
be very brief here.  For more information, please refer to [<<ref_11>>].  A
...
<<appendix_3>> has an example of configuring an FE component for a FIFO
Qdisc.
...
[horizontal]
[[ref_1,1]] [1] :: Braden, R., Clark, D. and S. Shenker, "Integrated Services in
                   the Internet Architecture: an Overview", RFC 1633, June 1994.

[[ref_2,2]] [2] :: Baker, F., "Requirements for IP Version 4 Routers", RFC 1812,
                   June 1995.

[[ref_3,3]] [3] :: Blake, S., Black, D., Carlson, M., Davies, E, Wang, Z. and W.
                   Weiss, "An Architecture for Differentiated Services", RFC 2475,
                   December 1998.

[[ref_4,4]] [4] :: Durham, D., Boyle, J., Cohen, R., Herzog, S., Rajan, R. and A.
                   Sastry, "The COPS (Common Open Policy Service) Protocol", RFC
                   2748, January 2000.

[[ref_5,5]] [5] :: Moy, J., "OSPF Version 2", STD 54, RFC 2328, April 1998.

[[ref_6,6]] [6] :: Case, J., Fedor, M., Schoffstall, M. and C. Davin, "Simple
                   Network Management Protocol (SNMP)", STD 15, RFC 1157, May 1990.

[[ref_7,7]] [7] :: Andersson, L., Doolan, P., Feldman, N., Fredette, A. and B.
                   Thomas, "LDP Specification", RFC 3036, January 2001.

[[ref_8,8]] [8] :: Bernet, Y., Blake, S., Grossman, D. and A. Smith, "An Informal
...
[horizontal]
[[ref_9,9]]    [9] :: G. R. Wright, W. Richard Stevens.  "TCP/IP Illustrated Volume 2,
                      Chapter 20", June 1995.

[[ref_10,10]] [10] :: http://www.netfilter.org

[[ref_11,11]] [11] :: http://diffserv.sourceforge.net
...
section, we illustrate only the addressing semantics.  In <<appendix_2>>,
...
. Connect to the IP service foo through a socket connect.  A typical
   connection would be via a call to: socket(AF_NETLINK, SOCK_RAW,
   NETLINK_FOO).

. Bind to listen to specific asynchronous events for service foo.

. Bind to listen to specific asynchronous FE events.


// Appendix 2
[[appendix_2,Appendix 2]]
...
These steps are continued from <<appendix_1>> (hence the numbering).

[start=4]
. Query for current config of FE component.

. Receive response to (4) via channel on (3).

. Query for current state of IP service foo.

. Receive response to (6) via channel on (2).

. Register the protocol-specific packets you would like the FE to
   forward to you.

. Send service-specific foo commands and receive responses for them,
   if needed.


// Appendix 2a
[[appendix_2a,Appendix 2a]]
== Appendix 2a: Interacting with Other IP services

The diagram in <<appendix_1>> shows another control component configuring
...
====
Errata ID: https://www.rfc-editor.org/errata/eid6014[6014] +
Status: Reported +
Type: Editorial +
...
<<errata_6014, Section 2.3.3.2>> says:
...
[subs=+macros]
....
pass:quotes[**Applicab**]le attributes:
....
