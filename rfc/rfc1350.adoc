...
|===
|                     [big]#THE TFTP PROTOCOL (REVISION 2)#
|===
...
[[errata_1712]]
== [.rfc-error-text]#Acknowlegements#
...
bug [<<ref4>>] and other minor document problems was done by Noel Chiappa.
...
on top of the Internet User Datagram protocol (UDP or Datagram) [<<ref2>>]
...
[<<ref1>>] with the modifications specified in "Telnet Protocol
Specification" [<<ref3>>].)  Note that it is 8 bit ascii.  The term
...
Reference [<<ref4>>] (section 4.2) should be consulted for further valuable
...
termination are acknowledged unless a timeout occurs [<<ref4>>].  Sending a
...
between 0 and 511 bytes of data [.rfc-error-text]#(i.e., Datagram length < 516)#.  This
...
Internet User Datagram Header [<<ref2>>]
...
[horizontal]
[[ref1,1]] [1] :: USA Standard Code for Information Interchange, USASI X3.4-1968.
[[ref2,2]] [2] :: Postel, J., "User Datagram  Protocol," RFC 768, USC/Information
                  Sciences Institute, 28 August 1980.
[[ref3,3]] [3] :: Postel, J., "Telnet Protocol Specification," RFC 764,
                  USC/Information Sciences Institute, June, 1980.
[[ref4,4]] [4] :: Braden, R., Editor, "Requirements for Internet Hosts --
...
====
Errata ID: https://www.rfc-editor.org/errata/eid4971[4971] +
Status: Verified +
Type: Editorial +
...
<<errata_4971,Section 6>> says:

[subs=+macros]
....
(i.e., Datagram length < pass:quotes[*516*])
....
...
[subs=+macros]
....
(i.e., Datagram length < pass:quotes[*512*])
....
...
====
Errata ID: https://www.rfc-editor.org/errata/eid1712[1712] +
