...
|===
|       [big]#A DNS RR for specifying the location of services (DNS SRV)#
|===
...
(the word domain is used here in the strict <<ref_RFC1034>> sense), and get
...
used in this document are to be interpreted as specified in [<<ref_BCP14>>].
Other terms used in this document are defined in the DNS
specification, <<ref_RFC1034>>.
...
as described in [<<ref_ARM>>].  The example zone file near the end of this
...
Numbers [<<ref_STD2>>] or locally.  An underscore (_) is prepended to
...
+
====
Standard DNS meaning [<<ref_RFC1035>>].
====

Class ::
+
====
Standard DNS meaning [<<ref_RFC1035>>].   SRV records occur in the IN
Class.
====
...
the sense of <<ref_RFC1034>> or <<ref_RFC2181>>).  Implementors are urged, but
...
- If a truncated response comes back from an SRV query, the rules
  described in [<<ref_RFC2181>>] shall apply.
...
[horizontal]
30{nbsp}bytes  :: general overhead
20{nbsp}bytes  :: for the query string, "_foobar._tcp.example.com."
130{nbsp}bytes :: for 4 SRV RR's, 20 bytes each plus the lengths of "new-
                  fast-box", "old-slow-box", "server" and "sysadmins-box" -
                  "example.com" in the query section is quoted here and doesn't
                  need to be counted again.
75{nbsp}bytes  :: for 3 NS RRs, 15 bytes each plus the lengths of "server",
                  "ns1.ip-provider.net." and "ns2" - again, "ip-provider.net." is
                  quoted and only needs to be counted once.
120{nbsp}bytes :: for the 6 address records (assuming IPv4 only) mentioned
...
////
1. std 1    missing
2. RFC 974  not mentioned
4. BCP 14   twice
5. rfc 2219 not mentioned
5. KDC-DNS  not mentioned
////


[horizontal]
[[ref_STD2,STD 2]] [STD 2] ::    Reynolds, J., and J. Postel, "Assigned Numbers", STD 2, RFC
                                 1700, October 1994.

[[ref_RFC1034, RFC 1034]] [RFC 1034] ::   Mockapetris, P., "Domain names - concepts and facilities",
                                          STD 13, RFC 1034, November 1987.

[[ref_RFC1035,RFC 1035]] [RFC 1035] :: Mockapetris, P., "Domain names - Implementation and
                                       Specification", STD 13, RFC 1035, November 1987.

[[ref_RFC974,RFC 974]] [RFC 974] :: Partridge, C., "Mail routing and the domain system", STD
                                    14, RFC 974, January 1986.

[[ref_BCP14, BCP 14]] [BCP 14] ::   Bradner, S., "Key words for use in RFCs to Indicate
                                    Requirement Levels", BCP 14, RFC 2119, March 1997.

[[ref_RFC2181,RFC 2181]] [RFC 2181] :: Elz, R. and R. Bush, "Clarifications to the DNS
                                       Specification", RFC 2181, July 1997.

[[ref_RFC2219, RFC 2219]] [RFC2219] :: Hamilton, M. and R. Wright, "Use of DNS Aliases for Network
                                       Services", BCP 17, RFC 2219, October 1997.

[[ref_BCP14_, BCP 14]] [BCP 14] ::  Bradner, S., "Key words for use in RFCs to Indicate
                                    Requirement Levels", BCP 14, RFC 2119, March 1997.

[[ref_ARM,ARM]] [ARM]  ::  Armijo, M., Esibov, L. and P. Leach, "Discovering LDAP
                           Services with DNS", Work in Progress.

[[ref_KDC-DNS, KDC-DNS]] [KDC-DNS] ::  Hornstein, K. and J. Altman, "Distributing Kerberos KDC and
