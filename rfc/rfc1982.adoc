...
supplies the missing definition.  It is intended to update <<ref_RFC1034>>
and <<ref_RFC1035>>.
...
<<ref_RFC1034>> uses the same terminology when defining secondary server zone
consistency procedures.

Unfortunately the term "sequence space arithmetic" is not defined in
either <<ref_RFC1034>> or <<ref_RFC1035>>, nor do any of their references provide
further information.

This phrase seems to have been intending to specify arithmetic as
used in TCP sequence numbers [<<ref_RFC793>>], and defined in [<<ref_IEN-74>>].

Unfortunately, the arithmetic defined in [<<ref_IEN-74>>] is not adequate for
...
definition is intended merely to clarify the intent of <<ref_RFC1034>> and
<<ref_RFC1035>>, and is believed to generally agree with current
...
[0 .. (2{caret}(SERIAL_BITS - 1) - 1)].  For a sequence number s, the
...
[0 .. (2{caret}(SERIAL_BITS - 1) - 1)] is undefined.
...
1, 2, and 3.  That is, 3 == 2{caret}SERIAL_BITS - 1.

In this space, the largest integer that it is meaningful to add to a
sequence number is 2{caret}(SERIAL_BITS - 1) - 1, or 1.
...
255 == 2{caret}SERIAL_BITS - 1.

In this space, the largest integer that it is meaningful to add to a
sequence number is 2{caret}(SERIAL_BITS - 1) - 1, or 127.
...
The maximum defined increment is 2147483647 (2{caret}31 - 1).
...
<<ref_RFC1034>> and <<ref_RFC1035>> are to be treated as if the references to
...
[horizontal]
[[ref_RFC1034,RFC1034]]  [RFC1034] ::  Domain Names - Concepts and Facilities, P. Mockapetris, STD 13, ISI, November 1987.
[[ref_RFC1035,RFC1035]]  [RFC1035] ::  Domain Names - Implementation and Specification P. Mockapetris, STD 13, ISI, November 1987
[[ref_RFC793,RFC793]]    [RFC793]  ::  Transmission Control protocol Information Sciences Institute, STD 7, USC, September 1981
[[ref_IEN-74,IEN-74]]    [IEN-74]  ::  Sequence Number Arithmetic William W. Plummer, BB&N Inc, September 1978
