...
|===
|             [big]#Incremental Zone Transfer in DNS#
|===
...
the server's current version, [.rfc-error-text]#just as in AXFR#.
...
query type is not recognized by the server, an AXFR (preceded by [.rfc-error-text]#a
...
[[errata_3197]]
[.rfc-error-text]#RRs# in the incremental transfer messages may be partial.  That is, if
a single RR of multiple RRs of the same RR type [.rfc-error-text]#changes#, only the
...
// sec.6
== Optional Condensation of Multiple Versions
...
=====
Errata ID: https://www.rfc-editor.org/errata/eid3197[3197] +
Status: Verified              +
Type: Technical               +
...
<<errata_3197,Section 4, pg.3>> says:
...
=====
Errata ID: https://www.rfc-editor.org/errata/eid3196[3196] +
...
<<errata_3196,Section 2, pg.2>> says:
