...
|===
|     [big]#Common DNS Operational and Configuration Errors#
|===
...
expand upon issues raised in [<<ref_RFC1537>>].
...
end and begin only with a letter or digit.  See [<<ref_RFC1035>>] and [<<ref_RFC1123>>].
(Labels were initially restricted in [<<ref_RFC1035>>] to start with
a letter, and some older hosts still reportedly have problems with
the relaxation in [<<ref_RFC1123>>].)  Note there are some Internet
hostnames which violate this rule (411.org, 1776.com).  The presence
of underscores in a label is allowed in [<<ref_RFC1033>>], except [<<ref_RFC1033>>]
...
the language in [<<ref_RFC1035,1035>>] is such that these rules are voluntary -- they
...
number is n*10{caret}(3+int(0.9+log10(m))) + m which translates to
...
[horizontal]
Refresh: ::
How often a secondary will poll the primary server to see
...
how long data will remain in other nameservers' cache.  ([<<ref_RFC1035>>]
defines this to be the minimum value, but servers seem
...
Popular documentation like [<<ref_RFC1033>>] recommended a day for the
...
can't also have an MX record for suzy.podunk.[.rfc-error-text]#edu#, or an A record, or
...
{nbsp}[<<ref_RFC1034>>] in section 3.6.2 says this should not be done, and [<<ref_RFC974>>]
...
of the MX hosts.  Internet SMTP mailers are required by [<<ref_RFC1123>>] to
...
WKS records are deprecated in [<<ref_RFC1123>>].  They serve no known useful
...
more information.  See [<<ref_RFC1183>>].
...
swift fixes, and even an RFC ([<<ref_RFC1535>>]) documenting the problem.


// sec.2.8
=== Authority and Delegation Errors (NS records)
...
// sec.4.2
=== Other Resolver and Server bugs
...
[horizontal]
[[ref_RFC974,RFC 974]]   [RFC{nbsp}974] :: Partridge, C., "Mail routing and the domain system", STD
              14, RFC 974, CSNET CIC BBN Laboratories Inc, January 1986.

[[ref_RFC1033,RFC 1033]]   [RFC{nbsp}1033] :: Lottor, M, "Domain Administrators Operations Guide", RFC
              1033, USC/Information Sciences Institute, November 1987.

[[ref_RFC1034,RFC 1034]]   [RFC{nbsp}1034] :: Mockapetris, P., "Domain Names - Concepts and Facilities",
              STD 13, RFC 1034, USC/Information Sciences Institute,
              November 1987.

[[ref_RFC1035,RFC 1035]]   [RFC{nbsp}1035] :: Mockapetris, P., "Domain Names - Implementation and
              Specification", STD 13, RFC 1035, USC/Information Sciences
              Institute, November 1987.

[[ref_RFC1123,RFC 1123]]   [RFC{nbsp}1123] :: Braden, R., "Requirements for Internet Hosts --
              Application and Support", STD 3, RFC 1123, IETF, October
              1989.

[[ref_RFC1178,RFC 1178]]   [RFC{nbsp}1178] :: Libes, D., "Choosing a Name for Your Computer", FYI 5, RFC
              1178, Integrated Systems Group/NIST, August 1990.

[[ref_RFC1183,RFC 1183]]   [RFC{nbsp}1183] :: Ullman, R., Mockapetris, P., Mamakos, L, and C. Everhart,
              "New DNS RR Definitions", RFC 1183, October 1990.

[[ref_RFC1535,RFC 1535]]   [RFC{nbsp}1535] :: Gavron, E., "A Security Problem and Proposed Correction
              With Widely Deployed DNS Software", RFC 1535, ACES
              Research Inc., October 1993.

[[ref_RFC1536,RFC 1536]]   [RFC{nbsp}1536] :: Kumar, A., Postel, J., Neuman, C., Danzig, P., and S.
              Miller, "Common DNS Implementation Errors and Suggested
              Fixes", RFC 1536, USC/Information Sciences Institute, USC,
              October 1993.

[[ref_RFC1537,RFC 1537]]   [RFC{nbsp}1537] :: Beertema, P., "Common DNS Data File Configuration Errors",
              RFC 1537, CWI, October 1993.

[[ref_RFC1713,RFC 1713]]   [RFC{nbsp}1713] :: A. Romao, "Tools for DNS debugging", RFC 1713, FCCN,
              November 1994.

[[ref_BOG,BOG]]   [BOG] :: Vixie, P, et. al., "Name Server Operations Guide for BIND",
...
=====
Errata ID: https://www.rfc-editor.org/errata/eid5381[5381] +
Status: Reported                    +
Type: Editorial                     +
...
NOTE: The .edu is a typo and should be corrected to .xx 
=====
